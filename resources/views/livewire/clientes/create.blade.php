    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title m-title" id="myModalLabel33">cliente - <b class="text-wprimary">Crear</b></h6>
            </div>
                        ...
                        <div class="col-lg">
                            <div class="mb-1">
                                ...
                                <select wire:model.defer="documento"
                                    class="form-select @error('documento') is-invalid @enderror" id="select-country1"
                                    required>
